                    ...
                    <div className="lg:h-64 pt-20 w-full relative">
                        <div className="absolute bottom-0 w-full">
                            ...
                            <form onSubmit={e => {e.preventDefault();}} className="w-full">
                                <div className="flex">
                                    <select id="device" defaultValue={"phone"} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm text-center rounded-l-lg focus:ring-blue-500 focus:border-blue-500 block w-1/5 p-2.5">
