    ...
    return (
        <Modal setShowModal={setShowModal}>
            ...
            <form class="space-y-6" onSubmit={handleUpdate}>
                ...
                <FormInput label={"Street"} type={"text"} defaultValue={supplier.address === null ? null: supplier.address.street} />
                <FormInput label={"ZIP"} type={"text"} defaultValue={supplier.address === null ? null: supplier.address.zip} />
                <FormInput label={"City"} type={"text"} defaultValue={supplier.address === null ? null: supplier.address.city} />
                <FormInput label={"Country"} type={"text"} placeholder={'DE'} defaultValue={supplier.address === null ? null: supplier.address.country} />
